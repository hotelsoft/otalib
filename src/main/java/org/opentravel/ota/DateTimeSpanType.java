...
@XmlSeeAlso({
    RFPRequestSegmentsType.RFPRequestSegment.Dates.Date.class,
    RFPRequestSegmentsType.RFPRequestSegment.Sites.Site.Promotions.Promotion.AvailableDateRange.class,
    HotelInfoType.BlackoutDates.BlackoutDate.class,
    EventReportType.GeneralEventInfo.Dates.Date.class,
