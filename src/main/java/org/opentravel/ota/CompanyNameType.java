...
@XmlSeeAlso({
    ...
    BaggageQueryType.AirlineCarrier.class,
    AllianceConsortiumType.AllianceMember.class,
    DirectBillType.CompanyName.class,
    VehicleAvailCoreType.Vendor.class,
    CompanyNamePrefType.class,
    PaymentFormType.Voucher.BillingAccountName.class,
    ContactInfoType.CompanyName.class,
