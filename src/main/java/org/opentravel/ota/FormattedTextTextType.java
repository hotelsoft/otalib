...
@XmlSeeAlso({
    RFPRequestSegmentsType.RFPRequestSegment.Preferences.Preference.LocationCategories.Category.class,
    FulfillmentType.PaymentText.class,
    EventReportType.GeneralEventInfo.Dates.Date.LocationCategories.Category.class,
    VehicleRentalDetailsType.ConditionReport.class,
    CustomQuestionType.ProvidedAnswerChoices.class,
    ...
    VideoDescriptionType.Description.class,
