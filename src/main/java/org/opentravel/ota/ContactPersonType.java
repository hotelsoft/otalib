...
@XmlSeeAlso({
    EventType.Event.Contacts.Contact.class,
    EventType.Event.EventInfos.EventInfo.Contacts.Contact.class,
    EventType.Event.Sites.Site.EventDays.EventDay.EventDayFunctions.EventDayFunction.Contacts.Contact.class,
    RFPResponseType.RFPResponseSegments.RFPResponseSegment.Sites.Site.References.Reference.class,
    EventReportType.GeneralEventInfo.EventContacts.EventContact.class,
    HotelRoomListType.Guests.Guest.class,
    HotelRoomListType.MasterContact.class,
    RecipientInfosType.RecipientInfo.class,
    PostEventSiteReportType.Contacts.Contact.class,
    PostEventSiteReportType.EventDays.EventDay.EventDayFunctions.EventDayFunction.Contacts.Contact.class
})
