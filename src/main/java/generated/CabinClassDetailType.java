 ...
 *       &lt;sequence>
 *         &lt;element name="AvailabilityList" type="{}CabinClassAvailabilityType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="RowInfo" type="{}RowDetailType" maxOccurs="999" minOccurs="0"/>
 *         &lt;element name="SeatInfo" type="{}SeatDetailsType" minOccurs="0"/>
 *         &lt;element name="Zone" type="{}SeatZoneSummaryType" maxOccurs="99" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlSeeAlso({
    generated.SeatMapDetailsType.CabinClass.class
})
public class CabinClassDetailType {

    @XmlElementRefs({
        @XmlElementRef(name = "Zone", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "RowInfo", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "SeatInfo", type = JAXBElement.class, required = false),
        @XmlElementRef(name = "AvailabilityList", type = JAXBElement.class, required = false)
    })
    @XmlMixed
